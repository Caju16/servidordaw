...
class EmailSender {
    ...
    public function sendConfirmationMail($name, $surname, $email, $token) {
        ...
        $email = (new Email())
            ...
            // ->text('')
            ->html('<p>Para poder loguearte en el porfolio de Creaciones, necesitamos que valides tu correo. Date prisa, tienes 24 horas!</p><br><a href="http://portfolios.local/verificar/'.$token.'">VALIDA TU CORREO</a>');
